...
const Home = () => {
  return (
    <div name='Home' className='h-full w-full bg-gradient-to-b from-zinc-200 to-zinc-400 text-gray-700' id='home'>
      <div className='flex container mx-auto py-20 px-5 flex-col md:flex-row items-center justify-center'>
        <div className='h-full md:w-1/2 ml-5 mb-8 md:pr-14'>
            ...
            <div className='w-5/6 md:w-1/2 lg:max-w-md rounded-2xl'>
